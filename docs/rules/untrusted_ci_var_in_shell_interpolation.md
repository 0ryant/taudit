# Untrusted Ci Var In Shell Interpolation

**Rule ID:** `untrusted_ci_var_in_shell_interpolation`
...
- [`crates/taudit-core/src/rules.rs`](../../crates/taudit-core/src/rules.rs) — detection implementation (`pub fn untrusted_ci_var_in_shell_interpolation`)
