# Pr Build Pushes Image With Floating Credentials

**Rule ID:** `pr_build_pushes_image_with_floating_credentials`
...
- [`crates/taudit-core/src/rules.rs`](../../crates/taudit-core/src/rules.rs) — detection implementation (`pub fn pr_build_pushes_image_with_floating_credentials`)
