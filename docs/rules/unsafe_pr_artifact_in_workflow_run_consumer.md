# Unsafe Pr Artifact In Workflow Run Consumer

**Rule ID:** `unsafe_pr_artifact_in_workflow_run_consumer`
...
- [`crates/taudit-core/src/rules.rs`](../../crates/taudit-core/src/rules.rs) — detection implementation (`pub fn unsafe_pr_artifact_in_workflow_run_consumer`)
