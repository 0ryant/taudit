...
Status: L6-01 through L6-05 audit, ledger setup, and marketplace proof-state
reconciliation.
...
[docs/proof/v1.2.0-rc.1/](../../proof/v1.2.0-rc.1/README.md). The reconciled
marketplace state is
[marketplace-proof-state.md](marketplace-proof-state.md). Until a completed
...
| L6-03 | Reconcile VS Code publication contradictions | Complete for proof-state wording; receipt still pending | [Marketplace proof state](marketplace-proof-state.md) resolves the contradiction by treating VS Code published-copy language as planned/pending receipt until VSC receipts are recorded. |
| L6-04 | Update the root marketplace action backlog state | Complete for proof-gated backlog state; receipt still pending | `TODOS.md` now states that implementation checklist items do not prove Marketplace publication, installability, tag readiness, or hosted smoke. |
...
| --- | --- | --- | --- | --- |
| GitHub Action | [Action contract](../../integrations/github-marketplace-action-contract.md); root action backlog; [runtime tranche](../../research/2026-05-15-marketplace-runtime-tranche.md) records local action work and a hosted smoke blocked before runner execution; [marketplace proof state](marketplace-proof-state.md). | `0ryant/taudit-action@v1` installability, immutable tag, moving `v1`, GitHub release, and Marketplace listing. | Hosted SHA smoke run URL, action commit SHA, taudit version, exit code, outcome, immutable tag readback, moving `v1` readback, release/listing URL, operator, timestamp, residual risk. | Planned/pending receipt. |
| Azure DevOps task | [ADO contract](../../integrations/azure-devops-marketplace-extension-contract.md); [live proof checklist](../../integrations/azure-devops-live-proof-checklist.md); [extension manifest](../../../integrations/azure-devops-extension/vss-extension.json); [task manifest](../../../integrations/azure-devops-extension/Taudit/task.json); [marketplace proof state](marketplace-proof-state.md). | A real installed `Taudit@1` operator run with expected outputs and artifact contents. Some docs use installable-task language; this audit treats that as pending until a receipt is recorded. | Azure run URL, pool/agent, extension version/ref, task version, source commit SHA, resolved taudit version, `tauditVerify.taudit.outcome`, `taudit-task-smoke` artifact file list, artifact checksum where applicable, sanitization note, residual risk. | Planned/pending receipt. |
| VS Code extension | [VS Code contract](../../integrations/visual-studio-marketplace-extension-contract.md); [operator guide](../../integrations/visual-studio-marketplace-extension-operator-guide.md); [manifest](../../../integrations/vscode-extension/package.json); [publish track](../../research/2026-05-15-visual-studio-marketplace-publish-track.md); [runtime tranche](../../research/2026-05-15-marketplace-runtime-tranche.md); [marketplace proof state](marketplace-proof-state.md). | Publication state and Marketplace installability are contradictory in local docs. No completed proof receipt is in this RC ledger. | VSIX path and checksum, local preflight command result, hosted preflight run URL, Marketplace listing URL/readback, installed extension id/version, command smoke result, source commit SHA, timestamp, operator, sanitization note, residual risk. | Planned/pending receipt for published-copy claims. |
...
## Reconciled Proof Gates

| Area | Reconciled state | Required receipt before stronger wording |
| --- | --- | --- |
| VS Code publication | Published-copy wording is planned/pending receipt even if tranche notes record a publish. | Record VSC-001 through VSC-004 receipts or keep broader docs proof-gated. |
| Azure DevOps live proof | Task-ready adoption proof is planned/pending receipt until one real `Taudit@1` run is recorded. | Record ADO-001 and ADO-002 receipts before claiming task-ready adoption proof. |
| Azure version alignment | Version/link wording remains pending L6-02 because source docs still differ on the stable taudit pin. | Version/link pass after the release/version owner confirms the intended stable pin. |
| GitHub Action state | Implementation checklist items are not publication proof; action wording remains planned/pending receipt. | Record GHA-001 through GHA-004 receipts before claiming hosted-smoked action, `v1` tag, release, or listing. |
